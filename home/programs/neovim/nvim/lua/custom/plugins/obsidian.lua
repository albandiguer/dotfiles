return {
  {
    ...
    keys = {
      ...
      { '<leader>obc', ':Obsidian toggle_checkbox<CR>', { noremap = true, silent = true, desc = 'Toggle Checkbox' } },
      { '<leader>obd', ':Obsidian dailies<CR>', { noremap = true, silent = true, desc = 'Dailies' } },
      { '<leader>obe', ':Obsidian extract_note<CR>', { noremap = true, silent = true, desc = 'Extract Note' } },
      { '<leader>obf', ':Obsidian new_from_template<CR>', { noremap = true, silent = true, desc = 'New From Template' } },
      { '<leader>obl', ':Obsidian link<CR>', { noremap = true, silent = true, desc = 'Link' } },
      { '<leader>obn', ':Obsidian new<CR>', { noremap = true, silent = true, desc = 'New' } },
      ...
      { '<leader>obt', ':Obsidian today<CR>', { noremap = true, silent = true, desc = 'Today' } },
    },
