  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    dependencies = {
      ...
      { -- If encountering errors, see telescope-fzf-native README for installation instructions
        ...
        -- `conf` is a condition used to determine whether this plugin should be
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>a', builtin.oldfiles, { desc = '[A]vante' })
      vim.keymap.set('n', '<leader>l', builtin.oldfiles, { desc = '[L]azygit' })
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          local map = function(keys, func, desc)
            vim.keymap.set('n', keys, func, { buffer = event.buf, desc = 'LfP: ' .. desc })
          end
  ...
  { -- Autocompletion
    ...
    dependencies = {
      -- Snippet Engine & its associated nvim-cmp source
      {
        'L3MON4D3/LuaSnip',
        lazy = false,
        -- build = (function() -- NOTE: not working?
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      statusline.setup {
        ...
        -- Override the default content to disable git section
        content = {
          active = function()
            local mode, mode_hl = statusline.section_mode { trunc_width = 120 }
            -- Git section is removed from here
