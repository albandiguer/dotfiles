...
vim.filetype.add {
  pattern = {
    ...
    ['.*%.pod$'] = 'systemd', -- podman quadlets pods ft TODO: merge w above
  },
}
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      --
      --  Add any additional override configuration to after/lsp folder, see LspInfo for options, for example:
